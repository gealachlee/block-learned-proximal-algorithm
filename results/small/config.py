...
parser.add('--train-size', type=int, default=2048, metavar='N',  # 51200 12800
           help='Number of training samples')
parser.add('--val-size', type=int, default=512, metavar='N',#2048
           help='Number of validation samples')
parser.add('--test-size', type=int, default=512, metavar='N',#2048
