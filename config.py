...
parser.add('--gLen', type=int, default=16, metavar='INT')
# parser.add('--sparsity', type=int, default=4, metavar='INT')
# parser.add('--gLen', type=int, default=16, metavar='INT')
...
parser.add('--snr', type=float, default=100000, metavar='FLOAT',
...
#parser.add('--objective', type=str, default='OBJECTIVE', metavar='{OBJECTIVE,L2,L1,GT}',
...
parser.add('--train-size', type=int, default=64, metavar='N',  # 51200 12800
           help='Number of training samples')
parser.add('--val-size', type=int, default=2048, metavar='N',
           help='Number of validation samples')
parser.add('--test-size', type=int, default=64, metavar='N',
           help='Number of testing samples')
parser.add('--train-batch-size', type=int, default=128, metavar='N',  # 512, metavar='N',
           help='Batch size for training')
parser.add('--val-batch-size', type=int, default=2048, metavar='N',  # 2048
           help='Batch size for validation')
parser.add('--test-batch-size', type=int, default=64, metavar='N',  # 2048
...
#
# # Data parameters
# parser.add('--m', type=int, default=128, metavar='INT',
#            help='Number of rows in matrix A')
# parser.add('--n', type=int, default=256, metavar='INT',
#            help='Number of cols in matrix A')
# parser.add('--sparsity', type=int, default=4, metavar='INT')
...
#
# # Model parameters
# parser.add('--layers', type=int, default=3, metavar='INT',
#            help='Number of layers of the neural network')
#
#
# # Training parameters
# #parser.add('--objective', type=str, default='GT', metavar='{OBJECTIVE,L2,L1,GT}',
# parser.add('--objective', type=str, default='GT', metavar='{OBJECTIVE,L2,L1,GT,GT2}',
#            help='Objective used for the training')
# parser.add('--save-dir', type=str, default='temp',
#            help='Saving directory for saved models and logs')
# parser.add('--train-size', type=int, default=4096, metavar='N',  # 51200 12800
#            help='Number of training samples')
# parser.add('--val-size', type=int, default=256, metavar='N',#2048
#            help='Number of validation samples')
# parser.add('--test-size', type=int, default=256, metavar='N',#2048
#            help='Number of testing samples')
# parser.add('--train-batch-size', type=int, default=64, metavar='N',  # 512, metavar='N',
#            help='Batch size for training')
# parser.add('--val-batch-size', type=int, default=2048, metavar='N',  # 2048
#            help='Batch size for validation')
